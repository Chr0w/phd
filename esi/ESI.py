...
class ESI(BaseSample):
    ...
    def _on_sim_step_event(self, event):
        try:
            ...
            print(f"Disabling esi sim callback after error: {exc}")
            self.deregister_sim_step_callback()
    ...
    def create_waypoint(self, x, y):
        ...
        try:
            ...
            waypoint_xform.AddTranslateOp().Set(Gf.Vec3f(x, y, 0.1))
            waypoint_xform.AddScaleOp().Set(Gf.Vec3f(0.3, 0.3, 0.1))
